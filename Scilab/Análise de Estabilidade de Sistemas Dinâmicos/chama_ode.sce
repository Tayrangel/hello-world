...
// A funcao modelo1.sci contem o sistema de EDOs a ser 
//  integrado 
...
y0=[2.0; 1.0];   // Vetor de condicoes iniciais... //Vetores do tempo inicial, condições iniciais, onde terá o y1 e y2 no tempo 0.
...
subplot(2,1,1) //Fazer o plot dos gráfico, porém tem a variável y1 e y2, para deixar organizado como 2 linhas e 1 coluna fica o subplot 1 (2-linha,1-coluna,1-é a variável a ser plotada)
plot(t,y(1,:),'k:') //Plota o gráfico da variável eixo t vs eixo y(1) em vários tempos, por isso inserir os :
xtitle("y1 em funcao do tempo")
subplot(2,1,2)
plot(t,y(2,:),'k:')
xtitle("y2 em funcao do tempo")
